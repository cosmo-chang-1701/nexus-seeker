...
from cogs.embed_builder import create_polymarket_list_embed, create_news_scan_embed, create_reddit_scan_embed, create_scan_embed
...
class IntelligenceCog(commands.Cog):
    ...
    async def scan_news(self, interaction: discord.Interaction, symbol: str, limit: int = 5):
        ...
        try:
            ...
            await interaction.followup.send(embed=create_news_scan_embed(symbol, news_text), ephemeral=True)
        except Exception as e:
    ...
    async def scan_reddit(self, interaction: discord.Interaction, symbol: str, limit: int = 5):
        ...
        try:
            ...
            await interaction.followup.send(embed=create_reddit_scan_embed(symbol, reddit_text), ephemeral=True)
        except Exception as e:

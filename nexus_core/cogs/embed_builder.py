...
def create_trades_embed(portfolio_rows: List[tuple], stock_quotes: Dict[str, float] = None, total_capital: float = 0.0) -> discord.Embed:
    ...
    for row in portfolio_rows:
        ...
        lines.append(f"{id_fmt} | {sym_fmt} | {exp_fmt} | {st_type_fmt} | {qty_fmt} | {status_fmt}")

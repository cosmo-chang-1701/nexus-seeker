...
- 互動設定與通知偏好中心（4 模組 20 頻道；頻道註冊表 `database/notification_channels.py`、集中推播入口 `services/notification_dispatcher.py`）→ [`03_notification_center.md`](docs/platform/03_notification_center.md)

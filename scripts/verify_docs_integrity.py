...
2. [STRUCTURE] Directory taxonomy and file count (all 32 specifications + docs/README.md).
...
7. [INDEX] Master index coverage (docs/README.md references all 32 specification documents).
...
# Required section definitions for 32 specification documents
...
class DocsVerifier:
    ...
    def battery_structure_and_count(self) -> BatteryResult:
        result: BatteryResult = BatteryResult(
            category="STRUCTURE",
            description="Directory taxonomy and 32 specification documents + README existence",
        )
        ...
        # Check all 32 specification documents
...
def run_self_tests() -> int:
    ...
    with tempfile.TemporaryDirectory() as temp_dir_str:
        ...
        # 2. Populate all 32 specification documents + README with compliant content

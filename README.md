...
> 核心版本（nexus_core）：**v1.10.22** (請參考最新 Release)
...
- **戰場情境轉折警報 (Market Scenario Alerts)**：整合獨立的事件驅動引擎，基於 **5 階 GEX 決策矩陣 (5-State Matrix)**，結合 Gamma Flip, IV Rank 與 Zero-Latency 的 Volume Profile (HVN/LVN) 邊界檢測。精準捕捉「結構破位轉倉」、「假性支撐陷阱」、「黃金波段止盈」、「強勢突破加碼」與「黃金左側加碼」，給予極致精準的資金派發指令。

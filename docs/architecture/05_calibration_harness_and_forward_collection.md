...
- **離線事件研究** (`nexus_core/calibration/`)
  ...
  - `nexus_core/calibration/microstructure.py`：GEX 牆體深度與週 EM 快照、守住率標註（§5.13）
